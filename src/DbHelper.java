...
public class DbHelper  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table User(id integer primary key autoincrement,username TEXT UNIQUE,lozinka TEXT,ime TEXT, prezime TEXT,adresa_stanovanja TEXT,pravo INT)");
    ...
    public Boolean insert_korisnike(String ime, String prezime, String adresa,String username,String lozinka){
